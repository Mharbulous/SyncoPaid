...
Expected: FAIL with "ArchiveWorker is not defined" or similar import error
...
Expected: FAIL with "ModuleNotFoundError: No module named 'syncopaid.archiver'" or archiver not initialized
