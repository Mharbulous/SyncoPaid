@echo off
REM TimeLogger Git Initialization Script for Windows
REM This script sets up a new Git repository and pushes to GitHub

echo.
echo ========================================
echo TimeLogger Git Setup for Windows
echo ========================================
echo.
...
set /p repourl="Enter your GitHub repository URL (e.g., https://github.com/username/TimeLogger.git): "
