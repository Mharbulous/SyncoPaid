#!/bin/bash
# SyncoPaid Git Initialization Script for Unix/Linux/macOS
...
echo ""
echo "========================================"
echo "SyncoPaid Git Setup for Unix/Linux/macOS"
echo "========================================"
echo ""
...
read -p "Enter your GitHub repository URL (e.g., https://github.com/username/SyncoPaid.git): " repourl
