...
class SyncoPaidApp:
    ...
    def record_time_marker(self):
        ...
        Stores as a 1-second event in the events table so it appears
        in the main window alongside other activity.
        """
        ...
        logging.info(f"Time marker recorded at {now.isoformat()}")
