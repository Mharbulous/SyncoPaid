#!/usr/bin/env python3
"""
Generate version information for SyncoPaid build.
...
4. Updates src/SyncoPaid/_version.py with version constants
  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'FileDescription', u'SyncoPaid - Automatic time tracking for lawyers'),
        StringStruct(u'FileVersion', u'{file_version}'),
        StringStruct(u'InternalName', u'SyncoPaid'),
        StringStruct(u'LegalCopyright', u'Copyright (c) 2025 Brahm Dorst'),
        StringStruct(u'OriginalFilename', u'SyncoPaid.exe'),
        StringStruct(u'ProductName', u'SyncoPaid'),
...
def generate_version_py(product_version, file_version):
    """
    Generate src/SyncoPaid/_version.py with version constants.
    ...
    Args:
        ...
        file_version: File version with commit hash (e.g., "1.0.0+89e840f")
    """
    version_py_path = Path(__file__).parent / 'src' / 'SyncoPaid' / '_version.py'
...
def main():
    ...
    print("=" * 60)
    print("SyncoPaid Version Generator")
    print("=" * 60)
    print()
