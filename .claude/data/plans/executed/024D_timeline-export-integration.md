# 024D: Timeline Export and UI Integration

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Story ID:** 4.6 | **Created:** 2025-12-22 | **Stage:** `planned`
**Parent Plan:** 024_activity-timeline-view.md (Sub-plan D of 4)
...
**Goal:** Add image export functionality and integrate timeline into the main application menu.
**Approach:** Use PIL/Pillow for PNG rendering, add menu item to main_ui_windows.py.
...
- [ ] Sub-plan 024C completed (TimelineCanvas and show_timeline_window exist)
...
| File | Change | Purpose |
|------|--------|---------|
| `tests/test_timeline_view.py` | Modify | Add test for image export |
| `src/syncopaid/timeline_view.py` | Modify | Add export_timeline_image function and button |
...
Update `show_timeline_window` to add export button. Find the control_frame section and add:

```python
# In show_timeline_window, after the Refresh button, add:
...
- This is the final sub-plan completing story 4.6
