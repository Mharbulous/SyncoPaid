# 024D: Timeline Canvas Widget and Window
...
**Goal:** Create tkinter canvas widget for timeline visualization with zoom/pan and a complete window with controls.
**Approach:** Build TimelineCanvas class extending tk.Canvas, then create show_timeline_window function with controls.
**Tech Stack:** tkinter (Canvas widget), threading
...
| File | Change | Purpose |
|------|--------|---------|
| `src/syncopaid/timeline_view.py` | Modify | Add TimelineCanvas class and show_timeline_window |
...
**Context:** Create the actual tkinter Canvas-based timeline widget that renders blocks and handles interactions.
