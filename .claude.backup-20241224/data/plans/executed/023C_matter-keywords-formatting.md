# 023C: Matter Keywords - Formatting Functions
...
**Goal:** Add keyword formatting functions for UI display.
**Approach:** Create testable utility functions to format keywords for display.
**Tech Stack:** Python (pure functions, no UI)
...
- [ ] Keyword formatting function created and tested
- [ ] Function to retrieve matters with formatted keywords
...
### Task 1: Add keyword formatting and retrieval functions (~5 min)

**Files:**
- Modify: `src/syncopaid/matter_client_dialog.py`
- Test: `tests/test_matter_keywords.py`

**Context:** The MatterDialog class (in matter_client_dialog.py) displays matters in a tkinter treeview. We need formatting functions that prepare keywords for display as comma-separated tags.
...
- This sub-plan creates the testable utility functions
- Sub-plan 023D will integrate these into the UI
...
023D: Matter Keywords UI Integration (treeview column + tooltip)
