...
## Context
Creates a simple modal dialog for client management. Users can view all clients, add new ones, edit existing, and delete.

## Scope
- Create `matter_client_dialog.py` module
- ClientDialog class with Listbox
- ClientEditDialog for add/edit form
...
| File | Purpose |
|------|---------|
| `src/syncopaid/matter_client_dialog.py` | New module (CREATE) |
| `tests/test_matter_client.py` | Add import test |

## Implementation

```python
# src/syncopaid/matter_client_dialog.py (CREATE)
...
python -c "from syncopaid.matter_client_dialog import ClientDialog; print('OK')"
```
