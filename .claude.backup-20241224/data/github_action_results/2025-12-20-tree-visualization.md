...
| Field | Value |
|-------|-------|
| Generated | 2025-12-20 13:14:09 UTC |
| Total Stories | 97 |
...
│   ├── (2.6) Screenshot Retention & Cleanup Policy [2/3] ●
│   │   ├── (2.6.1) Archive screenshots to monthly ZIP files [0/None] ❓
│   │   └── (2.6.2) Screenshot Metadata Index for Retention Rules [0/None] ·
...
│   ├── (5.5) Discrete Deletion of Sensitive Records [0/None] ·
