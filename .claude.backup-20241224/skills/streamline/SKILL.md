...
Autonomously identifies oversized source files (>300 lines), creates decomposition plans, and executes refactoring while preserving functionality exactly.
...
4. **Execute decomposition** - Create backup and refactor
