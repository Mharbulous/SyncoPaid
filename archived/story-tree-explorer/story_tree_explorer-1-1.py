#!/usr/bin/env python3
"""
Xstory v1.1 - Using tksheet for per-cell coloring
...
STATUS_COLORS = {
    ...
    'pending': '#00CC66',     # Emerald (was 'pending')
    'pending': '#00CC99',       # Teal Green (was 'bugged')
...
class XstoryExplorer:
    ...
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Xstory v1.1 (tksheet)")
